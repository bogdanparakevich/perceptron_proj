...
x1, x2, y_model, w0_model, w1_model, w2_model, b = gen_3D(n_dots = 100, x_min = 1, x_max = 10, w0_model = 0.2, w1_model = 1, w2_model = 2, M = -0.5, std = 1)
...
y_true = (perceptron_3D(x1, x2, y_model)[0] + perceptron_3D(x1, x2, y_model)[1]*x1 + perceptron_3D(x1, x2, y_model)[2]*x2)
